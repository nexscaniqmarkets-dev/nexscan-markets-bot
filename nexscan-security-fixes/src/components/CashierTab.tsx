...
import {
  ...
  Clock, AlertTriangle, CircleAlert, Zap, Star, Activity,
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-2.5 py-1.5 rounded-md bg-slate-950 border border-slate-805 focus:border-indigo-500 text-[10px] text-slate-200 placeholder:text-slate-600 outline-none transition-all font-mono h-[32px] text-left"
                          />
                          <button
                            type="button"
